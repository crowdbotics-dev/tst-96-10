"""
Django settings for tst_96_10 project.
...
WSGI_APPLICATION = 'tst_96_10.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_96_10 API",
    "DESCRIPTION": "API documentation for tst_96_10 App",
    "VERSION": "v1",
}
